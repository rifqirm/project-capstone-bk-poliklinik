      ...
      <div class="w-full max-w-full px-3 mt-0 mb-6">
        <div
          ...
          <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0 mb-4">
            <h6>
              <center>Tambah Jadwal Periksa</center>
            </h6>
          </div>
          <center>
            @if($errors->any())
          ...
          <form action="{{ route('dokter-create-jadwal-periksa') }}" method="POST"
            ...
            <div class="mb-4">
              ...
              <select name="jam_mulai" class="w-full p-2 border rounded-md"
                ...
                @for ($i = 0; $i < 24; $i++) @for ($j=0; $j < 60; $j +=15) {{-- Format jam --}} @php
                  $formattedHour=str_pad($i, 2, '0' , STR_PAD_LEFT); $formattedMinute=str_pad($j, 2, '0' ,
                  STR_PAD_LEFT); $formattedTime=$formattedHour . ':' . $formattedMinute; @endphp <option
            ...
            <div class="mb-4 flex justify-center">
              <button type="submit"
                ...
                style="background-image: linear-gradient(to bottom right, #00A9FF, #11fc00); color:white;">Tambahkan
