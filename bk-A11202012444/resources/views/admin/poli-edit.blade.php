      ...
      <div class="w-full max-w-full px-3 mt-0 mb-6">
        <div
          ...
          <form action="{{ route('admin-updatePoli',  $poli->id) }}" method="POST"
            ...
            @method('PUT')
            <div class="mb-4">
              <label for="nama_poli" class="block text-sm font-medium text-gray-700 mb-1" style="margin: 0.5rem;">Nama
                poli:</label>
              <input type="text" name="nama_poli" class="w-full p-2 border rounded-md"
                style="width: calc(100% - 1rem); padding: 0.5rem; border-radius: 0.375rem; margin: 0.5rem;"
                value="{{ $poli->nama_poli }}" required>
            </div>
            <div class="mb-4">
              <label for="keterangan" class="block text-sm font-medium text-gray-700 mb-1"
                style="margin: 0.5rem;">Keterangan:</label>
              <input type="text" name="keterangan" class="w-full p-2 border rounded-md"
                style="width: calc(100% - 1rem); padding: 0.5rem; border-radius: 0.375rem; margin: 0.5rem;"
                value="{{ $poli->keterangan }}" required>
            </div>
