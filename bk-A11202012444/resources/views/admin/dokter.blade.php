            ...
            <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
              <div class="flex flex-wrap mt-0 -mx-3">
                ...
                <div class="flex-none w-5/12 max-w-full px-3 mt-0 text-right lg:w-1/2 lg:flex-none">
                  <a href="{{ route('admin-createDokter') }}"
                    ...
                    <tr>
                      ...
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                        <div class="flex px-2 py-1">
                          <div class="flex flex-col justify-center">
                            <center>
                              <h6 class="mb-0 text-sm leading-normal">{{ $dokter->nama }}</h6>
                            </center>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">{{ $dokter->poli->nama_poli
                        }}</td>
                      ...
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                        <div class="flex justify-center items-center">
                          <a href="{{ route('admin-editDokter', $dokter->id) }}"
                            class="btn btn-warning mr-2 py-1 px-4 rounded-lg"
                            style="color: #ffffff; background: darkorange;">Edit</a>
