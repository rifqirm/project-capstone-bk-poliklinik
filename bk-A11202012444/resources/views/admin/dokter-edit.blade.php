      ...
      <div class="w-full max-w-full px-3 mt-0 mb-6">
        <div
          ...
          <form action="{{ route('admin-updateDokter',  $dokter->id) }}" method="POST"
            ...
            <select name="id_poli" class="p-2 border rounded-md"
              style="padding: 0.5rem; border-radius: 0.375rem; margin: 0.5rem;">
              @foreach($polis as $poli)
              <option value="{{ $poli->id }}" @if($poli->id == $dokter->id_poli) selected @endif>Bertugas di poliklinik
