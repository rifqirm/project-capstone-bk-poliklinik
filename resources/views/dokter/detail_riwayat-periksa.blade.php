                          ...
                          <div class="flex flex-col justify-center">
                            <center>
                              <h6 class="mb-0 text-sm leading-normal">{{
                                $detail_periksa->periksa->daftarPoli->pasien->nama }}</h6>
                            </center>
                          </div>
                        </div>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">{{
                        $detail_periksa->periksa->tgl_periksa }}</td>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">{{
                        $detail_periksa->periksa->catatan }}</td>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">{{
                        $detail_periksa->periksa->biaya_periksa }}</td>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
