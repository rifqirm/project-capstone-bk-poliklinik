                    ...
                    <tr>
                      ...
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                        <div class="flex px-2 py-1">
                          <div class="flex flex-col justify-center">
                            <center>
                              <h6 class="mb-0 text-sm leading-normal">{{ $poli->nama_poli }}</h6>
                            </center>
                          </div>
                        </div>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">{{ $poli->keterangan }}
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                        <div class="flex justify-center items-center">
                          <a href="{{ route('admin-editPoli', $poli->id) }}"
                          ...
                          <form action="{{ route('admin-destroyPoli', $poli->id) }}" method="POST"
                            ...
                            <button type="submit" class="btn btn-danger py-1 px-4 rounded-lg"
                              ...
                              onclick="return confirm('Apakah Anda yakin ingin menghapus poli ini?')">Hapus</button>
                          </form>
                        </div>
                      </td>
                    </tr>
