      ...
      <div class="w-full max-w-full px-3 mt-0 mb-6">
        <div
          ...
          <form action="{{ route('admin-updateObat',  $obat->id) }}" method="POST"
            ...
            @method('PUT')
            <div class="mb-4">
              <label for="nama_obat" class="block text-sm font-medium text-gray-700 mb-1" style="margin: 0.5rem;">Nama
                Obat:</label>
              <input type="text" name="nama_obat" class="w-full p-2 border rounded-md"
            ...
            <div class="mb-4">
              <label for="kemasan" class="block text-sm font-medium text-gray-700 mb-1"
                style="margin: 0.5rem;">Kemasan:</label>
              <input type="text" name="kemasan" class="w-full p-2 border rounded-md"
                style="width: calc(100% - 1rem); padding: 0.5rem; border-radius: 0.375rem; margin: 0.5rem;"
                value="{{ $obat->kemasan }}" required>
            </div>
            <div class="mb-4">
              <label for="harga" class="block text-sm font-medium text-gray-700 mb-1"
                style="margin: 0.5rem;">Harga:</label>
              <input type="number" name="harga" class="w-full p-2 border rounded-md"
                style="width: calc(100% - 1rem); padding: 0.5rem; border-radius: 0.375rem; margin: 0.5rem;"
